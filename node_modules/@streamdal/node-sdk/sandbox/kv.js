import { ExecStatus, OperationType, registerStreamdal, } from "../index.js";
...
export const kvExample = async () => {
    ...
    setInterval(async () => {
        ...
        `key ${key0.event_id} exists:`, result.status === ExecStatus.TRUE);
    }, 1000);
    //
    // eslint-disable-next-line @typescript-eslint/no-misused-promises
    setInterval(async () => {
        ...
        console.debug(
        // eslint-disable-next-line @typescript-eslint/restrict-template-expressions
        `key ${key1.event_id} exists:`, result.status === ExecStatus.FALSE);
    }, 1000);
};

import { WASMExitCode, WASMRequest, WASMResponse, } from "@streamdal/protos/protos/sp_wsm";
...
export const instantiateWasm = async (wasmId, wasmBytes) => {
    ...
    const instantiated = await WebAssembly.instantiate(wasm, {
        ...
        env: {
            kvExists: (pointer, length) => kvExists(instantiated.exports, pointer, length),
...
export const writeResponse = (pointer, length) => {
    //
...
export const runWasm = ({ step, originalData, interStepResult, }) => {

...
exports.kvExample = void 0;
const index_js_1 = require("../index.js");
const billing_js_1 = require("./billing.js");
const serviceKVConfig = {
 ...
 */
const kvExample = async () => {
    const kvService = await (0, index_js_1.registerStreamdal)(serviceKVConfig);
    const kvData = (0, billing_js_1.loadData)("./src/sandbox/assets/sample-welcome-producer.json");
    const key0 = kvData[0];
    const key1 = kvData[1];
    //
    ...
    setInterval(async () => {
        ...
        `key ${key0.event_id} exists:`, result.status === index_js_1.ExecStatus.TRUE);
    }, 1000);
    //
    // eslint-disable-next-line @typescript-eslint/no-misused-promises
    setInterval(async () => {
        ...
        console.debug(
        // eslint-disable-next-line @typescript-eslint/restrict-template-expressions
        `key ${key1.event_id} exists:`, result.status === index_js_1.ExecStatus.FALSE);
    }, 1000);
};
exports.kvExample = kvExample;
